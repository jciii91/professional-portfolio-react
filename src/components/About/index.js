        ...
        <>
            <div className='flex-row align-center'>
                ...
                <div className=' flex-row col-10 pt-2'>
                    ...
                    <br></br>
                    <p>I can be reached on my cell phone at (201) 961 - 4714, or through email at jcostello711@gmail.com. Thank you for visiting, and I hope to speak with you soon.</p>
                </div>
            </div>
        </>
    );
